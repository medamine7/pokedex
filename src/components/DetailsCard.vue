<template>
  ...
  >
    <template v-if="item">
      <div class="flex justify-between pt-3 px-3 items-center h-8 box-border">
        <div class="h-5 w-5">
          <img :src="item.sprite" :alt="item.name" class="h-full w-full object-contain" draggable="false" />
        </div>
  
        <x-badge class="bg-white flex gap-2 m-auto" data-role="hp-badge">
